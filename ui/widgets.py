...
class SLM2Panel(QtWidgets.QGroupBox):
    def __init__(self, parent=None):
        ...
        self.calib_dist_init.setDecimals(3)
        ...
        self.calib_dist_range.setDecimals(3)
        self.calib_dist_range.setRange(0.0, 2000.0)
        self.calib_dist_range.setValue(100.0)
        self.calib_dist_step = QtWidgets.QDoubleSpinBox()
        self.calib_dist_step.setDecimals(3)
        self.calib_dist_step.setRange(0.001, 500.0)
        ...
        self.calib_restore_button = QtWidgets.QPushButton("恢复")
        ...
        center_btn_layout.addWidget(self.calib_restore_button)
